...
namespace EastFive.Web.Extensions
{
    static class EncodersExtensions
    {
        /// <summary>
        ...
        public static byte[] Base64UrlDecode(this string input)
        {
            ...
            return input.Base64UrlDecode(offset: 0, count: input.Length);
        }
        ...
        /// Throws <see cref="FormatException"/> if the input is malformed.
        /// </remarks>
        public static byte[] Base64UrlDecode(this string input, int offset, int count)
        {
            if (input == null)
            {
                throw new ArgumentNullException(nameof(input));
        ...
        /// Throws <see cref="FormatException"/> if the input is malformed.
        /// </remarks>
        public static byte[] Base64UrlDecode(this string input, int offset, char[] buffer, int bufferOffset, int count)
        {
            if (input == null)
            {
                throw new ArgumentNullException(nameof(input));
        ...
        public static string Base64UrlEncode(this byte[] input)
        {
            ...
            return input.Base64UrlEncode(offset: 0, count: input.Length);
        }
